                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Container(
                                            ...
                                            height: customHeight,
                                            color: Colors.grey.shade800,
                                            child: Center(child: Text(item.ad)),
                                          ),
                                        ),
                                      ],
                                    )),
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Container(
                                            ...
                                            color: Colors.grey.shade800,
                                            child: Center(
                                                child: Text(item.sFToplammiktar
                                                    .toString())),
                                          ),
                                        ),
                                      ],
