...
class DialogFb1 extends StatelessWidget {
  ...
  const DialogFb1({Key? key, required this.onPressed}) : super(key: key);
  final primaryColor = const Color.fromARGB(255, 243, 8, 8);
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
                "Aktif iş emriniz bulunmaktadır. Lütfen iş emrini sonlandırınız...",
                style: TextStyle(
                    color: Colors.black,
                    fontSize: 14,
